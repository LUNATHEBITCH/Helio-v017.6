  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today: "text-gray-300 font-medium rounded-md aria-selected:!bg-white aria-selected:!text-black",
        day_outside:
        ...
        day_range_middle:
          "aria-selected:bg-[#414141] aria-selected:text-gray-400 aria-selected:rounded-md",
